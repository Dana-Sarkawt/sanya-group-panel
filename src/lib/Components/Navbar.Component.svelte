...
<Navbar let:NavContainer class="bg-transparent dark:bg-transparent">
  ...
  >
    <NavBrand href="/">
      ...
      <span
        class="self-center whitespace-nowrap text-xl font-semibold text-[#104e35] dark:text-white"
        >Sanya Group</span
      >
    </NavBrand>
    ...
    <NavUl
      ...
      ulClass="bg-transparent dark:bg-transparent md:bg-transparent dark:md:bg-transparent border-0 mt-4  flex items-center flex-col p-4 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:text-sm md:font-medium"
    >
