...
export interface IInboxRepository {
	...
	readInboxAsync(id: number): Promise<PostgrestSingleResponse<InboxEntity>>;

	readInboxesAsync(options?: GenericListOptions): Promise<PostgrestSingleResponse<InboxEntity[]>>;

	updateInboxAsync(
		request: Database['public']['Tables']['Inbox']['Update']
	): Promise<PostgrestSingleResponse<InboxEntity>>;

	deleteInboxAsync(id: number): Promise<void>;
}
