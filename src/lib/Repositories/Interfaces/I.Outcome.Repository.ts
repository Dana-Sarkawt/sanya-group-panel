...
export interface IOutcomeRepository {
    ...
    readOutcomesWithoutFilterAsync(): Promise<
        PostgrestSingleResponse<Array<Database["public"]["Tables"]["Outcome"]["Row"]>>
    >;
    readOutcomesByProjectIdAsync(projectId: number): Promise<
        PostgrestSingleResponse<Array<Database["public"]["Tables"]["Outcome"]["Row"]>>
    >;
    readOutcomesByProjectIdsAsync(projectIds: number[]): Promise<
        PostgrestSingleResponse<Array<Database["public"]["Tables"]["Outcome"]["Row"]>>
    >;
    readOutcomesByWorkerIdAsync(workerId: number): Promise<
        PostgrestSingleResponse<Array<Database["public"]["Tables"]["Outcome"]["Row"]>>
    >;
    readOutcomesByWorkerIdsAsync(workerIds: number[]): Promise<
        PostgrestSingleResponse<Array<Database["public"]["Tables"]["Outcome"]["Row"]>>
    >;
