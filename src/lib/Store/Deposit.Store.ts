...
const createDepositStore = () => {
	...
	return {
		subscribe,
		set: async (data: Store<Database['public']['Tables']['Deposits']['Row']>) => set(data),
		create: async (data: Database['public']['Tables']['Deposits']['Insert']) => {
			try {
		...
		update: async (data: Database['public']['Tables']['Deposits']['Update']) => {
			try {
