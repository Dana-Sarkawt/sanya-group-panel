...
<div class="w-full h-auto flex flex-wrap justify-center items-start pt-12 gap-4">

        <!-- svelte-ignore a11y-click-events-have-key-events -->
        <div class="w-[300px] h-[300px] rounded-lg bg-[#228c62] dark:bg-[#0F4E35] hover:bg-[#33b883] dark:hover:bg-[#1e9163] flex flex-col justify-center items-center text-white text-2xl duration-300 ease-in-out cursor-pointer"
    ...
    <a href="#">
        <div class="w-[300px] h-[300px] rounded-lg bg-[#228c62] dark:bg-[#0F4E35] hover:bg-[#33b883] dark:hover:bg-[#1e9163] flex flex-col justify-center items-center text-white text-2xl duration-300 ease-in-out">
            <img src="" alt="">
            <p>Language</p>
        </div>
    </a>
